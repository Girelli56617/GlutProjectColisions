...
void renderScene() {
	...
	float deltaTime = (float)(currentTime - sphere->previousTime) / 1000.0f;
...
//ajusta a projeção dos objetos quando a janela tem seu tamanho modificado

void resize(int weight, int height) {

	//impede uma divisão por zero
